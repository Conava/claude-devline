---
name: dl-frontend-dev
description: Domain logic for frontend UI/UX development — injected into agents that build or review UI components. Provides framework-agnostic guidance for web, mobile, and desktop with focus on distinctive, production-grade aesthetics. Not invoked directly.
...
Use the context7 MCP server to look up current documentation for the detected framework.
...
For platform-specific patterns and advanced techniques:

- **`references/web-patterns.md`** — React, Vue, Angular, Svelte patterns and best practices
- **`references/mobile-patterns.md`** — Flutter, SwiftUI, Jetpack Compose patterns
- **`references/desktop-patterns.md`** — JavaFX, Electron, Tauri patterns
