...
German-specific AI writing patterns, translation pitfalls, and style norms. Use alongside the general tropes catalog when writing, editing, or translating German text.

Sources: ContentConsultants, Stroeer, Martin Moeller, Advertext, German Wikipedia (Anzeichen fuer KI-generierte Inhalte), LanguageTool, RoboPhilosophy, Meinrad Blog, KONVENS 2024.
...
Fix: Use the plain word. "aendern" not "revolutionieren". "genau" not "praezise". "vollstaendig" not "umfassend" (or better: just say what's included).
...
- "Zusammenfassend laesst sich sagen, dass..." (In summary, one can say that...)
- "Darueber hinaus" (Furthermore) -- appears multiple times per paragraph
...
- "steht als Zeugnis fuer" (stands as testimony to)
- "Tauchen Sie ein" (Immerse yourself / Dive in)
- "eine Welt" (a world) as in "discover a world of..."
- "Zauber der..." (magic of...)
- "aufs naechste Level bringen" (take to the next level)
...
In English, "-ing" forms are natural everywhere. In German, extended present participle constructions like "gewährleistend" (ensuring), "hervorhebend" (highlighting), "beruecksichtigend" (considering) are extremely rare in normal prose. Extended Partizipialattribute (e.g., "die sich auf dem Tisch befindende Vase") are valid only in highly formal scientific/bureaucratic German and sound jarring elsewhere.

Bad: "Die sich stetig veraendernde Technologielandschaft gewährleistend..."
Fix: Use a relative clause: "Die Technologie veraendert sich staendig." Or a subordinate clause with "die" / "der" / "das".
...
Bad: "Wir werden Ihre Traeume erfuellen" (We will fulfill your dreams)
Fix: "Wir erfuellen Ihre Traeume." Direct present tense is more natural in German.

### Missing human elements

AI German text lacks: dialect coloring (Dialektfaerbung), experiential perspective, emotional specificity, unexpected reasoning, humor. When telling stories, it repeats "ploetzlich" (suddenly) or "dann" (then) mechanically.
...
The biggest translation problem. English "you" gives no formality signal, so AI guesses -- often switching mid-text. "Waehlen Sie die Datei" (formal) followed by "oeffne das Menue" (informal) in the same paragraph.
...
- eventually/eventuell: "eventually" = schliesslich; "eventuell" = vielleicht
- actual/aktuell: "actual" = tatsaechlich; "aktuell" = current
- Gift/gift: "Gift" (DE) = poison; "gift" (EN) = Geschenk
- sensibel/sensible: "sensibel" = sensitive; "sensible" = vernuenftig
...
- "Feedback geben" instead of "Rueckmeldung geben"
- "Meeting" instead of "Besprechung" or "Treffen"
- "Skills" instead of "Faehigkeiten" or "Kenntnisse"
...
- "It's raining cats and dogs" -> should be "Es giesst wie aus Kuebeln" (not "Es regnet Katzen und Hunde")
- "Break a leg" -> should be "Toi, toi, toi" or "Hals- und Beinbruch"
- "The ball is in your court" -> should be "Du bist am Zug" or "Jetzt bist du dran"
...
Wrong: "Er sagte, er ist muede." (indicative -- sounds like the writer confirms it)
Right: "Er sagte, er sei muede." (Konjunktiv I -- neutral reporting)

Also: AI overuses "wuerde" (would) constructions instead of proper Konjunktiv II for common verbs ("kaeme" not "wuerde kommen", "haette" not "wuerde haben").

### Comma rules

German comma rules are strict and differ from English:
- Subordinate clauses MUST be separated by commas: "Ich weiss, dass er kommt."
...
In Nebensaetze, the conjugated verb goes to the end: "Ich weiss, dass er heute nach Hause kommt." AI occasionally places verbs in English-influenced positions.
...
- Standard (Gaensefuesschen): „Text" -- opening LOW (99-shape), closing HIGH (66-shape)
...
- NO Eszett (ss). Always "ss": "Strasse" not "Strasse", "gross" not "gross"
...
### Austrian German (Oesterreichisches Deutsch)
...
- "ae" instead of "ae", "oe" instead of "oe", "ue" instead of "ue"
- "ss" instead of "ss"
...
Also watch for: Mojibake (garbled characters like "Ã¤" instead of "ae") from UTF-8/ISO-8859-1 mismatches, and files written in ANSI encoding instead of UTF-8.
