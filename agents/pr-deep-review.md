---
name: pr-deep-review
description: "Use this agent as the final gate before merging. Performs a comprehensive deep review covering security audit, credential scanning, code quality, technical debt, convention adherence, plan compliance, and architecture integrity. This is the most thorough review in the pipeline. Examples:\\n\\n<example>\\nContext: All work packages implemented and reviewed, pipeline reaching final stage\\nuser: \"Everything is implemented and reviewed, do the final PR review\"\\nassistant: \"I'll use the pr-deep-review agent to perform the final comprehensive merge-readiness review.\"\\n<commentary>\\nPipeline is at the final gate. Deep review checks everything holistically before approving merge.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User wants a standalone PR review\\nuser: \"/devline:pr Review this branch for merge readiness\"\\nassistant: \"I'll use the pr-deep-review agent to perform a comprehensive PR review.\"\\n<commentary>\\nUser wants the full PR review without having gone through the full pipeline.\\n</commentary>\\n</example>\\n"
